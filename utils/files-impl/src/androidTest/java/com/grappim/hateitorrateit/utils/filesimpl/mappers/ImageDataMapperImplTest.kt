...
class ImageDataMapperImplTest {
    ...
    @Test
    fun toProductImageData_should_return_correct_ProductImageData() = runTest {
    ...
    @Test
    fun toImageData_should_return_correct_ImageData() = runTest {
        val uri = getRandomUri()
        val id = getRandomLong()
        val name = getRandomString()
        val size = getRandomLong()
    ...
    @Test
    fun toProductImageDataList_should_return_correct_List_of_ProductImageData() = runTest {
    ...
    @Test
    fun toImageDataList_should_return_correct_List_of_ImageData() = runTest {
