...
class BackupProductMapperTest {
    ...
    @Test
    fun `toBackupProductImageDataEntity maps ProductImageData to BackupProductImageDataEntity correctly`() =
        runTest {
            val productId = 1L
            val images = listOf(
    ...
    @Test
    fun `toProductImageData maps BackupProductImageDataEntity to ProductImageData correctly`() =
        runTest {
            val entities = listOf(
